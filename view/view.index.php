            ...
            <div class="row">
                <div class="four columns">
                    <ul id="principal" class="menu">
                        <li class="enlace"><h3>Contacto</h3></li>
                        <li class="enlace"><p>Nombre: Moises Otero Cabrero</p></li>
                        <li class="enlace"><p>Registro 22310402</p></li>
                        <li class="enlace"><p>Carrera: Desarrollo de Software</p></li>
                    </ul>
                </div>
                <div class="four columns">
                    <ul id="secundaria" class="menu">
                        <li class="enlace"><h3>Escuela</h3></li>
                        <li class="enlace"><p>Centro de Enseñanza Tccnica Industrial</p></li>
                    </ul>
                </div>
            </div>
        </div>
